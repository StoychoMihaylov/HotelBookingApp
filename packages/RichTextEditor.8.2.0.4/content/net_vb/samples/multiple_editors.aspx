...
<script runat="server">
	...
	Private Sub btn_sumbit_click(ByVal sender As Object, ByVal e As EventArgs)
		lit_result.Text = "<div style='font-size:16px;font-weight:bold;'>RichTextEditor 1:</div><br/>" + Editor1.Text + "<br/><div style='font-size:16px;font-weight:bold;'>RichTextEditor 1:</div><br/>" + Editor2.Text
	End Sub
</script>
