...
<body>
    <script type="text/javascript">
        ...
        function ClientCommand(comm, type) {
            ...
            switch (comm) {
                ...
                case "focus":
                    editor.Focus();
                    divcode.innerHTML = "editor.Focus();";
                    break;
                case "movehome":
    ...
    <h1>
        JavaScript API</h1>
    <p>
        This example shows you how to use RichTextEditor JavaScript API to customize the
        application.
    </p>
    <div>
    ...
    <br />
    <div id="div_code" style="padding: 10px; border: solid 1px #cccccc; width: 580px;
        height: 40px; background-color: #ffffcc; overflow-y: auto; color: Blue;">
    </div>
    <br />
    <div>
        <button type="button" onclick="ClientCommand('gethtml','js');">
            get HTML</button>
        <button type="button" onclick="ClientCommand('sethtml','js');">
            set HTML</button>
        <button type="button" onclick="ClientCommand('inserthtml','js');">
            insert HTML</button>
        <button type="button" onclick="ClientCommand('codetab','js');">
            set Active Tab to Code</button>
        <button type="button" onclick="ClientCommand('focus','js');">
            set Focus</button>
        <br />
        <button type="button" onclick="ClientCommand('attachtextchanged','js');">
            attach Event(TextChanged)</button>
        <button type="button" onclick="ClientCommand('detachtextchanged','js');">
            detach Event(TextChanged)</button>
        <button type="button" onclick="ClientCommand('movehome','js');">
            move Home</button>
        <button type="button" onclick="ClientCommand('moveend','js');">
            move End</button>
    </div>
    <br />
    <div>
        ...
        <button type="button" onclick="ClientCommand(null,'command');">
            ExecCommand</button>
    </div>
